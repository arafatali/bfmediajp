...
if (!function_exists('replaceMonthName')) {
    ...
    {
        $str = strTrim($str);
        $str = strReplace("1月", trans("January"), $str);
        $str = strReplace("2月", trans("February"), $str);
        $str = strReplace("3月", trans("March"), $str);
        $str = strReplace("4月", trans("April"), $str);
        $str = strReplace("5月", trans("May"), $str);
        $str = strReplace("6月", trans("June"), $str);
        $str = strReplace("7月", trans("July"), $str);
        $str = strReplace("8月", trans("August"), $str);
        $str = strReplace("9月", trans("September"), $str);
        $str = strReplace("10月", trans("October"), $str);
        $str = strReplace("11月", trans("November"), $str);
        $str = strReplace("12月", trans("December"), $str);
        return $str;
    }
}
