...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/admin/plugins/file-manager/file-manager-2.2.css'); ?>">
    ...
    <?php endif; ?>
    <script>var VrConfig = {baseURL: '<?= base_url(); ?>', csrfTokenName: '<?= csrf_token() ?>', sysLangId: '<?= $activeLang->id; ?>', textSelectImage: "<?= trans("select_image"); ?>", textOk: "<?= trans("ok"); ?>", textCancel: "<?= trans("cancel"); ?>", textProcessing: "<?= trans("txt_processing"); ?>"};</script>
</head>
